...
const HomePage = {
  ...
  renderContent(container, loc, timings, hijri, verse, dua, virtue) {
    ...
    container.innerHTML = `
      ...
      <!-- Prominent Hijri Calendar Button -->
      <div style="padding: 0 var(--sp-md); margin-top: -20px; margin-bottom: var(--sp-md); position: relative; z-index: 2;">
      ...
      <div style="padding: var(--sp-md);">
        ...
        ${verse ? `
          ...
          <div class="card-gradient">
            ...
            <div class="verse-translation">"${verse['translation_' + (AppState.settings.language || 'es')] || verse.translation_es}"</div>
            <div class="verse-source">— ${verse.surahName} ${verse.surahNumber}:${verse.ayahNumber}</div>
            <div class="verse-wisdom">
              <i class="fas fa-lightbulb"></i>
              <span>${verse['wisdom_' + (AppState.settings.language || 'es')] || verse.wisdom_es}</span>
            </div>
          </div>
        ` : ''}
